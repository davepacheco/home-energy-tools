...
pub struct StatsResponse {
    ...
    pub intervals: Vec<crate::models::StatsResponseIntervals>,
}

impl StatsResponse {
    pub fn new(system_id: i32, total_devices: i32, meta: crate::models::Meta, intervals: Vec<crate::models::StatsResponseIntervals>) -> StatsResponse {
        StatsResponse {
            system_id,
            total_devices,
            meta: Box::new(meta),
