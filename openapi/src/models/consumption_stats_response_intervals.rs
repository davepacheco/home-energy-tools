...
pub struct ConsumptionStatsResponseIntervals {
...
impl ConsumptionStatsResponseIntervals {
    pub fn new(end_at: i64, enwh: i32, devices_reporting: i32) -> ConsumptionStatsResponseIntervals {
